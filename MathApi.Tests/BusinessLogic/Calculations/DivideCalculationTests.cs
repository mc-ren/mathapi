...
namespace MathApi.Tests.BusinessLogic.Calculations
{
    public class DivideCalculationTests
    {
        ...
        public void DivideTests(double number1, double number2, double number3, double number4, double number5)
        {
            // arrange
            var numbersToCalc = new List<double> { number1, number2, number3, number4, number5 };
            var divide = new DivideCalculation();

            // act
            var response = divide.Calculate(numbersToCalc);
